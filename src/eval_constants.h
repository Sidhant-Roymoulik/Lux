...
int pst[6][64] = {
    {S(-64, -64), S(-64, -64), S(-64, -64), S(-64, -64), S(-64, -64), S(-64, -64), S(-64, -64), S(-64, -64),
     ...
     S(-86, -8),  S(-43, -22), S(-48, -47), S(-10, -60), S(2, -62),   S(-9, -65),  S(-5, -44),  S(-76, -45),
    ...
    {S(1, -45),   S(26, -49), S(-197, -10), S(-123, -10), S(-112, -3), S(-61, -20), S(-14, -19), S(2, -50),
     ...
     S(9, -16),   S(19, 9),   S(37, 16),    S(115, 2),    S(82, 13),   S(87, 6),    S(12, 1),    S(13, -7),
    ...
    {S(-55, -40), S(-83, 88),  S(25, 37),  S(7, 40),    S(185, -38), S(210, -74), S(85, -29),  S(72, 18),
     S(-50, -49), S(-79, 21),  S(-16, 47), S(-39, 88),  S(-73, 132), S(126, -8),  S(60, 33),   S(118, -50),
     S(-19, -62), S(-29, -16), S(13, -17), S(-5, 96),   S(40, 73),   S(126, 22),  S(103, -12), S(123, -33),
