...
## 1. Fix crashes and timeouts in OpenBench games
- [ ] Investigate "abandoned" game terminations and engine disconnects seen during SPRT tests
- [ ] The crash at move 51 in the game log suggests a possible illegal state or unhandled edge case
- [ ] Check for time management issues (engine running out of time / timeout disconnect)
- [ ] Add any relevant assertions or logging to narrow down root cause

## 2. SPSA tuning support (OpenBench integration)
